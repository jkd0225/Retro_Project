...
public class UsersInfoVo {
	...
	public UsersInfoVo(String user_email, String user_password, String user_name, int user_profile, int user_point,
			Date user_regdate, int user_enabled, List<AuthVo> authorities) {
		super();
	...
	public String toString() {
		return "UsersInfoVo [user_email=" + user_email + ", user_password=" + user_password + ", user_name=" + user_name
				+ ", user_profile=" + user_profile + ", user_point=" + user_point + ", user_regdate=" + user_regdate
				+ ", user_enabled=" + user_enabled + ", authorities=" + authorities + "]";
	}
